(function () {
  ...
  mdColorMenuController['$inject'] = ['mdPickerColors', '$scope', '$rootScope'];
  function mdColorMenuController(mdPickerColors, $scope, $rootScope) {
    ...
    function selectColor(color) {
      ...
      console.log(color);
      $rootScope.colorCode = color.hex;
      var colorObjectArray = JSON.parse(localStorage.getItem('colorPicker'));
      colorObjectArray[0].colorCode = color.hex;
      console.log(colorObjectArray);
      localStorage.setItem('colorPicker',  JSON.stringify(colorObjectArray));
